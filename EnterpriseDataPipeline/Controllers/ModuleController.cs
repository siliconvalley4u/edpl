    ...
    public class ModuleController : Controller    
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                //vm.allModuleTB = db.ModuleTB.ToList();
                //vm.allModuleServer = db.ModuleServer.ToList(); 
        ...
        public ActionResult RunInstallation(string module, string destinationServerIP)        
        {
            ...
            string strInstallationState = "Installation Failed";
            ...
            try
            {
                ...
                //Find Puppet Server Parameters
                var sPuppetServerParameters = db.PuppetServer;
                ...
                //string strCmd = "python /root/prasanna-work/connect-host.py -host <hostname> -user <user-name> -pass <password> -packages <packages>";
                //string strCmd = "python /tmp/MyAutomation/ssh.py -e <private-ec2-server-name> -u <user-name> -p <password> -k <packages>";
                //string strCmd = "python /tmp/MyAutomation/ssh.py -e <private-ec2-server-name> -i <private-ec2-ip> -u <user-name> -p <password> -k <packages>";
                ...
                using (SshClient client = new SshClient(connectionInfo))
                {
                    ...
                    if (client.IsConnected)
                    {
                        ...
                        {
                            strInstallationState = "Installed Successfully";
                        }
                        //else
                        //{
